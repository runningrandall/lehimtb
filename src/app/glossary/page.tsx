...
const sections = [
    ...
    },
    {
        ...
        terms: [
            ...
            { term: 'Pre-Ride', def: 'When a rider rides an upcoming race course before the race to learn key technical spots. Official pre-rides occur the weekend before (or 2 weeks prior for Panguitch) and Friday evening before race day. Pre-riding on race morning is strictly prohibited.' },
    ...
    },
    {
        ...
        terms: [
            ...
            { term: 'Race Day', def: 'The day of a race event — includes arrival, pit zone check-in, arm numbering, wave meetings, staging call-ups, the race itself, finish line catchers, and podiums.' },
            { term: 'Call-Ups', def: 'The staging process where riders enter the race chute as their name (top 10) or arm number is called. 7th graders are randomized for race 1; 8th graders and HS riders are seeded based on prior placement and league points.' },
            ...
            { term: 'Finish Line Coach Zone & Catchers', def: 'The area past the finish line strictly reserved for coaches. Junior Development (JD) coaches "catch" riders as they cross the finish line to evaluate their condition, provide cold water and seating, and walk them out to meet parents.' },
